      ...
      <main className="pt-28 pb-12 flex-grow">
        <div className="container mx-auto max-w-4xl px-6">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900">ÁLTALÁNOS SZERZŐDÉSI FELTÉTELEK</h1>
          ...
          <div className="space-y-8 leading-relaxed text-gray-700">
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">1. A Szolgáltató adatai</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">2. Alapvető rendelkezések és a Fogyasztók kizárása</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">3. A Szerződéskötés és a Regisztráció folyamata</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">4. A Felhasználó kötelezettségei és a Fiók biztonsága</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">5. Fizetési feltételek</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">6. Szállítási feltételek és Kárveszély</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">7. Göngyöleg és Visszaváltási Rendszer (DRS)</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">8. Felelősségkorlátozás és Vis Maior</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">9. A Szerződés módosítása és Fiók törlése</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">10. Panaszkezelés és Jogvita</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">11. Vegyes rendelkezések</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-4">12. Rendelések módosítása és lemondása</h2>
