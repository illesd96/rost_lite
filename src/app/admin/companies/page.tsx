  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-2xl font-black text-gray-900">Cégek</h1>
        <Link
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          ...
          <h2 className="text-xl font-bold text-gray-400 mb-2">Még nincs regisztrált cég</h2>
          <p className="text-gray-400 mb-6">Hozd létre az első céget az &ldquo;Új cég regisztrációja&rdquo; gombbal.</p>
        </div>
      ) : (
        <div className="space-y-3">
          {companies.map(company => (
            <div key={company.id} className="bg-white p-5 rounded-2xl border border-gray-200 shadow-sm flex items-center justify-between">
              <div>
