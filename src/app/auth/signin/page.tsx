...
export default function SignInPage() {
  ...
  return (
    ...
    >
      <div className="hidden dark:block absolute inset-0 bg-black/60 z-0" />
      <main className="relative z-10 w-full max-w-6xl mx-auto py-10">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="flex flex-col w-full items-center lg:items-start">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-6 sm:p-8 border border-gray-100 dark:border-gray-800 w-full max-w-lg">
              ...
              <button
                ...
                className="flex items-center gap-4 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 hover:border-emerald-300 hover:bg-emerald-50/50 transition-all cursor-pointer group w-full text-left"
              >
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-8 sm:p-10 w-full max-w-md mx-auto border border-gray-100 dark:border-gray-800 relative">
            <Link
              href="/modern-shop"
              className="inline-flex items-center text-sm font-medium text-gray-400 dark:text-gray-500 hover:text-emerald-700 mb-8 transition-colors group no-underline"
            >
            ...
            <header className="mb-8">
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">Jelentkezz be a következő rendelésed leadásához</p>
            </header>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all placeholder:text-gray-400 dark:placeholder:text-gray-500 text-gray-900 dark:text-gray-100 disabled:opacity-50"
                />
                {errors.email && (
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 dark:text-gray-500 hover:text-emerald-600 transition-colors focus:outline-none"
                  >
